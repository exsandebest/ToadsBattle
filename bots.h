...
private:
    ...
    //get functions
    std::vector<step> getStepsPool(const std::vector<std::vector<int> >& table, const int queryPlayerNumber);
    std::vector<std::vector<bool> > getControlTable(const std::vector<std::vector<int> >& table,const  int queryPlayerNumber);
